...
public class IdMachine {
    ...
    private final static Logger logger = LoggerFactory.getLogger(IdMachine.class);
    ...
    private IdMachine(long workerId) {
    ...
    private static IdMachine flowIdWorker = new IdMachine(1);
    public static IdMachine getFlowIdWorkerInstance() {
        return flowIdWorker;
    }
